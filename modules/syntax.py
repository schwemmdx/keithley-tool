...
STYLES = {
    'keyword': format('#6c99bb'),
    'operator': format('#e87d3e'),
    'brace': format('#9e86c8'),
    'function': format('#b4d273'),
    'string': format('#e5b567'),
    'string2': format('#e5b567'),
    'comment': format('#797979', 'italic'),
    'numbers': format('#b05279'),
}


class PythonHighlighter (QtGui.QSyntaxHighlighter):
    """Syntax highlighter for the TSP language.
    """
    # Python keywords
    keywords = [
        ...
        'None', 'True', 'False','end','function','smu',
        'measure','source','then','insert'
    ]
    ...
    def __init__(self, parent: QtGui.QTextDocument) -> None:
        ...
        rules += [
            ...
            (r'\bend\b\s*(\w+)', 1, STYLES['function']),
